...
const page = () => {
    ...
    const fetchContactBannerSecData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/faq-page/Content_Section/${id}`)
        ...
        <>
            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    <h2 className="db-hd">Edit {pageName} {parentHeading} {para}</h2>
                    <form action="" className="db-form" encType="multipart/form-data" onSubmit={(e) => {
                        ...
                        <textarea type="text" name="heading" id="heading" value={paraValue} onChange={(e) => setparaValue(e.target.value)} className="header-input" placeholder="Mini Heading Goes here" required />
