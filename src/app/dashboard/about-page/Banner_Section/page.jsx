            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    ...
                    <form action="" className="db-form" encType="multipart/form-data" onSubmit={(e) => {
                        ...
                        <input type="text" name="title" id="title" defaultValue={value2} onChange={(e) => setvalue2(e.target.value)} className="header-input" placeholder="Main Heading Goes here" required />
