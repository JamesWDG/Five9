...
const page = () => {
    ...
    const fetchAboutPageData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/about-us-page/main-list`, {
                method: "GET",
                // headers: {
                        ...
                        <tbody>
                            {
                                aboutMainList?.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item?.type}</td>
                                        <td>
                                            <button onClick={() => router.push(`/dashboard/about-page/${listNav[item?.slug]}?id=${item?.id}`)} className="form-submit-btn text-white">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
