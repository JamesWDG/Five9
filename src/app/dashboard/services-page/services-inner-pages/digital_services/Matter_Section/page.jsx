...
const page = () => {
    ...
    const fetchAboutBannerSecData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-services-page/digital-services-page/Matter_Section/${id}`)
    ...
    const updateAboutBannerSecData = async () => {
        try {
            ...
            formData.append("file_1", value4)
            formData.append("file_2", value5)
            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    ...
                    <form action="" className="db-form" encType="multipart/form-data" onSubmit={(e) => {
                        ...
                        <label htmlFor="file_1" className="db-hd-mini mt-5">edit {heading4}</label>
                        <input type="file" name="file_1" id="file_1" defaultValue={value4} onChange={(e) => setvalue4(e.target.files[0])} className="header-input" placeholder="Mini Heading Goes here" />
                        
                        <label htmlFor="file_2" className="db-hd-mini mt-5">edit {heading5}</label>
                        <input type="file" name="file_2" id="file_2" defaultValue={value5} onChange={(e) => setvalue5(e.target.files[0])} className="header-input" placeholder="Mini Heading Goes here" />
