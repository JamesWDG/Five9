...
const page = () => {
    ...
    const fetchHomePageData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-services-page/digital-services-page/main-list`, {
                method: "GET",
                headers: {
        ...
        <>
            ...
            <section className="db-table dashboard-inner-pages">
                <div className="container-fluid">
                    <h2 className="db-hd">Edit Digital Services Page</h2>
                        ...
                        <tbody>
                            {
                                list?.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item?.type}</td>
                                        <td>
                                            <button onClick={() => router.push(`/dashboard/services-page/services-inner-pages/digital_services/${listNav[item?.slug]}/?id=${item?.id}`)} className="form-submit-btn text-white">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
