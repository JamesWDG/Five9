...
const page = () => {
    ...
    const listNav = {
        ...
        Development_Process_Section: 'Development_Process_Section',
    ...
    const fetchHomePageData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-services-page/strategy-page/main-list`, {
                method: "GET",
                headers: {
        ...
        <>
            ...
            <section className="db-table dashboard-inner-pages">
                <div className="container-fluid">
                    <h2 className="db-hd">Edit Strategy Page</h2>
                        ...
                        <tbody>
                            {
                                list?.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item?.type}</td>
                                        <td>
                                            <button onClick={() => router.push(`/dashboard/services-page/services-inner-pages/strategy/${listNav[item?.slug]}/?id=${item?.id}`)} className="form-submit-btn text-white">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
