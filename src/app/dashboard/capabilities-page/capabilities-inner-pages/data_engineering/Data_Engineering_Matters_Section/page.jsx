...
const page = () => {
    ...
    const fetchAboutBannerSecData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-capabilities-page/data-engineering-page/Data_Engineering_Matters_Section/${id}`)
