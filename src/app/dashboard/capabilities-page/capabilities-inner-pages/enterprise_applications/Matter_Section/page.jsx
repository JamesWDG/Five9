...
const page = () => {
    ...
    const fetchAboutBannerSecData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-capabilities-page/enterprise-applications-page/Matter_Section/${id}`)
            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    ...
                    <form action="" className="db-form" encType="multipart/form-data" onSubmit={(e) => {
                        ...
                        <label htmlFor="file_1" className="db-hd-mini mt-5">edit {heading3}</label>
                        <input type="file" name="file_1" id="file_1" defaultValue={value3} onChange={(e) => setvalue3(e.target.files[0])} className="header-input" placeholder="Mini Heading Goes here" />
