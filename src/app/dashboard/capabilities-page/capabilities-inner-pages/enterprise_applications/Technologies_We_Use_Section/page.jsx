...
const page = () => {
    ...
    const fetchAboutBannerSecData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-capabilities-page/enterprise-applications-page/Technologies_We_Use_Section/${id}`)
            ...
            <section className="dashboard-inner-pages">
                <div className="container-fluid">
                    ...
                    <form action="" className="db-form" encType="multipart/form-data" onSubmit={(e) => {
                        ...
                        <label htmlFor="points" className="db-hd-mini mt-5">{heading2}</label>
                        <TextEditor
                            value={value2}
