...
const page = () => {
    ...
    const listNav = {
        ...
        Transformations_Fails_Section: 'Transformations_Fails_Section',
    ...
    const fetchHomePageData = async () => {
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/cms/our-capabilities-page/transformation-page/main-list`, {
                method: "GET",
                headers: {
        ...
        <>
            ...
            <section className="db-table dashboard-inner-pages">
                <div className="container-fluid">
                    <h2 className="db-hd">Edit transformation Page</h2>
                        ...
                        <tbody>
                            {
                                list?.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td>{item?.type}</td>
                                        <td>
                                            <button onClick={() => router.push(`/dashboard/capabilities-page/capabilities-inner-pages/transformation/${listNav[item?.slug]}/?id=${item?.id}`)} className="form-submit-btn text-white">
                                                Edit
                                            </button>
                                        </td>
                                    </tr>
