    ...
    <>
      ...
      <section className='term-sec'>
        <div className="container">
          ...
          <ul className='term-list'>
            <li className='banner-para'><span>Usage Data: </span> PrivacyPolicyClients visited, time spent, links clicked, and navigation patterns</li>
          ...
          <p className='banner-para'>We may update this privacy policy periodically. Changes are posted on this PrivacyPolicyClient with an updated "Last Updated" date. Significant changes will be communicated via email or website notice.</p>
